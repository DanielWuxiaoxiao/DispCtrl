    ...
    : QGraphicsView(parent)
{
    ...
    QTimer::singleShot(100, this, [this]() {
        emit radarCenterChanged(m_radarLongitude, m_radarLatitude, m_currentRange);
        LOG_INFO(QString("PPIView初始化完成，发送初始雷达位置：%1,%2，范围：%3km")
...
void PPIView::onMaxDistanceChanged(double distance)
{
    ...
    LOG_INFO(QString("PPI范围更新：%1km，雷达位置：%2,%3")
...
void PPIView::setRadarCenter(double longitude, double latitude)
{
    ...
    // 发出雷达中心位置变化信号，通知地图组件更新
    emit radarCenterChanged(m_radarLongitude, m_radarLatitude, m_currentRange);
    
    LOG_INFO(QString("雷达中心位置更新：%1,%2，范围：%3km")
